...
<html lang="en">
  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <marquee behavior="scroll" direction="left">SELAMAT DATANG DI E-LIBRARY FAKULTAS ILMU KOMPUTER 2022</marquee>

    <div class="card">
          <div class="card-header">
            <h3 class="card-title text-center">UNSIKA E-LIBRARY</h3>
          </div>
    </div>
...
<section id="blog" class="py-3 text-center">
        <div class="row">
            <div class="col-md-6 col-lg-3">
                ...
                <div class="card-header">
                  <h4><strong>BUKU</strong></h4></div>
                    <div class="card-body">
                        <h4>Tersedia : 129</h4>
                        <a href="buku/index.php" type="button" class="btn btn-link" style="color:white;">More Info</button></a>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-3">
                ...
                <div class="card-header">
                  <h4><strong>USER</strong></h4></div>
                    <div class="card-body">
                    <h4>Tersedia : 129</h4>
                        <a href="user/index.php" type="button" class="btn btn-link" style="color:white;">More Info</button></a>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-3">
                ...
                <div class="card-header">
                  <h4><strong>PEMINJAMAN</strong></h4></div>
                    <div class="card-body">  
                    <h4>Tersedia : 129</h4>
                        <a href="peminjaman/index.php" type="button" class="btn btn-link" style="color:white;">More Info</button></a>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-3">
                ...
                <div class="card-header">
                  <h4><strong>PENGEMBALIAN</strong></h4></div>
                    <div class="card-body">
                    <h4>Tersedia : 129</h4>
                        <a href="pengembalian/index.php" type="button" class="btn btn-link" style="color:white;">More Info</button></a>
                    </div>
                </div>
            </div>
        </div>
