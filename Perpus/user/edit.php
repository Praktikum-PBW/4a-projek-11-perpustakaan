...
if(isset($_POST['edit'])){
    ...
    $sql=mysqli_query ($koneksi,"UPDATE user SET id_user='$id_user', nama_user='$nama_user', jk_user='$jk', no_telp='$no', alamat_user='$alamat' WHERE id_user='$id_user'" ) or die($koneksi);
    if ($sql){
        echo"
            <script> 
