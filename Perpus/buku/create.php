...
if(isset($_POST['create'])){
    ...
    $stok = $_POST['stok'];
    $sql = mysqli_query($koneksi,"INSERT INTO buku VALUES('$id_buku','$nama_buku','$jenis_buku','$penerbit','$tahun','$stok')");
        if ($sql) {
...
<h2>Buat Data Buku</h2>
    ...
    <div class="col">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="id_buku" id="id_buku" placeholder="Masukan ID Buku">
        </div>
        <div class="mb-3">
